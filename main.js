...
let projects = [
  {
    image: 'textures/autogram.png',
    url: 'https://sparshgaur369.github.io/AutoGramAI-landing/',
  },
  {
    image: 'textures/innotrix.png',
    url: 'https://innotrix.vercel.app/',
  },
  {
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('SPARSH GAUR', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Developer / ML Engineer / Content Creator',
      {
        font: font,
        size: 0.018,
        height: 0,
